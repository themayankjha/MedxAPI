...
def symptomsdata():
        ...
        skin_rash=request.args.get("skin_rash")
        nodal_skin_eruptions=request.args.get("nodal_skin_eruptions")
        continuous_sneezing=request.args.get("continuous_sneezing")
        shivering=request.args.get("shivering")
        chills=request.args.get("chills")
        joint_pain=request.args.get("joint_pain")
        stomach_pain=request.args.get("stomach_pain")
        acidity=request.args.get("acidity")
        ulcers_on_tongue=request.args.get("ulcers_on_tongue")
        muscle_wasting=request.args.get("muscle_wasting")
        vomiting=request.args.get("vomiting")
        burning_micturition=request.args.get("burning_micturition")
        spotting_urination=request.args.get("spotting_urination")
        fatigue=request.args.get("fatigue")
        weight_gain=request.args.get("weight_gain")
        anxiety=request.args.get("anxiety")
        cold_hands_and_feets=request.args.get("cold_hands_and_feets")
        mood_swings=request.args.get("mood_swings")
        weight_loss=request.args.get("weight_loss")
        restlessness=request.args.get("restlessness")
        lethargy=request.args.get("lethargy")
        patches_in_throat=request.args.get("patches_in_throat")
        irregular_sugar_level=request.args.get("irregular_sugar_level")
        cough=request.args.get("cough")
        high_fever=request.args.get("high_fever")
        sunken_eyes=request.args.get("sunken_eyes")
        breathlessness=request.args.get("breathlessness")
        sweating=request.args.get("sweating")
        dehydration=request.args.get("dehydration")
        indigestion=request.args.get("indigestion")
        headache=request.args.get("headache")
        yellowish_skin=request.args.get("yellowish_skin")
        dark_urine=request.args.get("dark_urine")
        nausea=request.args.get("nausea")
        loss_of_appetite=request.args.get("loss_of_appetite")
        pain_behind_the_eyes=request.args.get("pain_behind_the_eyes")
        ...
        foul_smell_ofurine=request.args.get("foul_smell_ofurine")
        ...
        fluid_overload_one=request.args.get("fluid_overload_one")
