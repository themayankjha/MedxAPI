...
def heartandstrokedatabaseentry(username,age,height,weight,gender,bloodpressure,diabetes,smoking,anaemia,lastcheckup,hypertension,heartdisease,married,worktype,residencetype,glucoselevel):
    ...
    cursor.execute(sql, val)
    strokepredictionlist=stroke(gender,age,hypertension,heartdisease,married,worktype,residencetype,glucoselevel,smoking,weight,height)
    ...
    val2 = (username,heartfailprediction,strokeprediction)
    print(type(username))
    print(type(heartfailprediction))
    print(type(strokeprediction))
    print(type(heartfailprediction.item()))
    print(type(strokeprediction.item()))
